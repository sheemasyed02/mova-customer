...
export default function HomePermissionScreen() {
    ...
    try {
      ...
      if (status === 'granted') {
        ...
        Alert.alert(
          ...
          [{ text: 'Continue', onPress: () => router.push('/(features)/onboarding/notification-permission' as any) }]
        );
      } else {
        // Permission denied
        Alert.alert(
          ...
          [
            ...
            { text: 'Continue Without', onPress: () => router.push('/(features)/onboarding/notification-permission' as any) },
          ]
        );
      }
    } catch (error) {
  ...
  const skipPermission = () => {
    router.push('/(features)/onboarding/notification-permission' as any);
  };
