    ...
    if (Platform.OS === 'ios') {
      ActionSheetIOS.showActionSheetWithOptions(
        ...
        (buttonIndex) => {
          switch (buttonIndex) {
            case 0:
              router.push(`/vehicle-details-page?id=${vehicle.id}` as any);
              break;
            case 1:
      ...
      Alert.alert(
        ...
        'Choose an action',
        [
          { text: 'View Details', onPress: () => router.push(`/vehicle-details-page?id=${vehicle.id}` as any) },
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          if (editMode) {
            ...
            router.push(`/vehicle-details-page?id=${item.id}` as any);
          }
        }}
