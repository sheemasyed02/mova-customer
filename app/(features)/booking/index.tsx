import AddonsExtras from '@/app/(features)/booking/addons-extras';
import BookingConfirmation from '@/app/(features)/booking/booking-confirmation';
import DateTimeSelection from '@/app/(features)/booking/date-time-selection';
import Payment from '@/app/(features)/booking/payment';
import ReviewConfirm from '@/app/(features)/booking/review-confirm';
